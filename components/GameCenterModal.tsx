...
interface GameCenterModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSelectGame: (game: 'wheel' | 'slots') => void;
}
      ...
      >
         ...
         <div className="grid grid-cols-2 gap-4">
            ...
            >
               ...
               <div className="w-12 h-12 bg-amber-500/20 rounded-full flex items-center justify-center text-2xl mb-3 group-hover:scale-110 transition-transform">
                  🎡
               </div>
               <h3 className="font-bold text-white text-lg">عجلة الحظ</h3>
               <p className="text-xs text-slate-400 mt-1">جرب حظك وضاعف رصيدك حتى x8</p>
            ...
            >
               ...
               <div className="w-12 h-12 bg-pink-500/20 rounded-full flex items-center justify-center text-2xl mb-3 group-hover:scale-110 transition-transform">
                  🎰
               </div>
               <h3 className="font-bold text-white text-lg">ماكينة الخضار</h3>
               <p className="text-xs text-slate-400 mt-1">لعبة السلوتس الكلاسيكية اربح حتى x20</p>
